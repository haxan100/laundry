-- Laundry POS System Database
-- Import this SQL file to create all required tables

-- Create setting_harga_laundry table
CREATE TABLE IF NOT EXISTS `setting_harga_laundry` (
...
-- Create setting_harga_ongkir table
CREATE TABLE IF NOT EXISTS `setting_harga_ongkir` (
...
ALTER TABLE `customers` ADD COLUMN IF NOT EXISTS `tier_id` int(11) DEFAULT 1 AFTER `alamat`;
ALTER TABLE `customers` ADD COLUMN IF NOT EXISTS `total_transaksi` int(11) DEFAULT 0 AFTER `tier_id`;
