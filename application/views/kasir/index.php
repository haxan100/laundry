            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    const transactionData = {
                        ...
                        no_hp: customerPhone,
                        berat: calculationData.berat,
                        jarak_km: $('#deliveryCheck').is(':checked') ? calculationData.jarak_km : 0,
                        harga_per_kg: calculationData.harga_per_kg,
                        harga_per_km: calculationData.harga_per_km || 0,
                        tier_laundry: calculationData.tier,
                        tier_ongkir: calculationData.tier_ongkir_name || null,
